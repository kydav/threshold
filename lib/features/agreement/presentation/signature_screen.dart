...
class _SignatureScreenState extends ConsumerState<SignatureScreen> {
  ...
  Future<void> _finalize() async {
    ...
    try {
      final agentImg =
          await _agentPadKey.currentState!.toImage(pixelRatio: 2.0);
      final agentBytes = await agentImg.toByteData(
          format: ui.ImageByteFormat.png) as ByteData;

      final buyerImg =
          await _buyerPadKey.currentState!.toImage(pixelRatio: 2.0);
      final buyerBytes = await buyerImg.toByteData(
          format: ui.ImageByteFormat.png) as ByteData;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            FilledButton.icon(
              onPressed:
                  (_agentSigned && _buyerSigned && !_processing) ? _finalize : null,
              icon: _processing
                  ? const SizedBox(
                      height: 18,
                      width: 18,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _row('Term',
                '${_fmt(a.startDate)} – ${_fmt(a.endDate)}'),
          ],
        ),
      ),
    );
